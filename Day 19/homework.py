...
def zipp (a, b, c):
    ...
    while i < min_len:
        ...
        i+=1
        d.append(result)
    d.append((get_max(a, b, c)[1])[(get_max(a, b, c))[0]:]) # აქ ვიძახებ პირველ get_max(a, b, c ფუნქციას, რომელიც აბრუნებს სიას 2 ელემენტით (უდიდესი სიის დასახელება და ელემენტების რაოდენობის სხვაობა უმცირეს სიასთან)
    return d
